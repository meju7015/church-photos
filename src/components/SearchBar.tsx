  ...
  return (
    <form onSubmit={handleSubmit} className="relative">
      <input
        ...
        placeholder="앨범 검색..."
        className="w-full px-4 py-2.5 pl-10 bg-[var(--surface-card)] border border-[var(--border)] rounded-2xl text-sm text-[var(--text)] placeholder-[var(--text-sub)] focus:ring-2 focus:ring-primary focus:border-transparent outline-none"
      />
