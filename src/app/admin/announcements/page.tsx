...
export default function AdminAnnouncementsPage() {
  ...
  return (
    <div>
      ...
      {pinnedList.length > 0 && (
        <div className="mb-4">
          <h2 className="text-sm font-bold text-candy-orange mb-3 flex items-center gap-1.5">
          ...
          <div className="bg-[var(--surface-card)] rounded-3xl border border-candy-orange/30 divide-y divide-[var(--border)] overflow-hidden">
      ...
      {editingId && (
        <>
          ...
          <div className="fixed inset-0 z-[201] flex items-center justify-center p-4">
            <div className="bg-[var(--surface-card)] rounded-3xl border border-[var(--border)] w-full max-w-md shadow-2xl p-6 space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={handleEdit}
                  disabled={editSaving}
                  className="flex-1 py-2.5 gradient-candy text-white rounded-2xl text-sm font-bold disabled:opacity-50"
                >
                  {editSaving ? '저장 중...' : '저장'}
                </button>
              </div>
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              {ann.pinned && (
                <span className="text-[10px] font-bold text-candy-orange bg-candy-orange/10 px-2 py-0.5 rounded-full">고정</span>
              )}
